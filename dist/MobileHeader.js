...
var MobileHeader = /*#__PURE__*/function (_React$Component) {
  ...
  function MobileHeader(props) {
    ...
    _this.toggleCoursesDropdown = _this.toggleCoursesDropdown.bind(_assertThisInitialized(_this));
    return _this;
  }
  _createClass(MobileHeader, [{
    key: "toggleCoursesDropdown",
    value: function toggleCoursesDropdown() {
    ...
    value: function renderMainMenu() {
      ...
      var isCoursesDropdownOpen = this.state.isCoursesDropdownOpen;
      ...
      return mainMenu.map(function (menuItem) {
        ...
        if (content === 'Courses') {
          return /*#__PURE__*/React.createElement("div", {
            ...
            role: "button",
            tabIndex: "0",
            onClick: _this2.toggleCoursesDropdown,
            onKeyPress: _this2.toggleCoursesDropdown
          }, content), isCoursesDropdownOpen && /*#__PURE__*/React.createElement("div", {
            className: "dropdown-menu show"
          }, /*#__PURE__*/React.createElement("a", {
            href: "/courses/for_students",
            className: "dropdown-item"
          }, "For Students"), /*#__PURE__*/React.createElement("a", {
