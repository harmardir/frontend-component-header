...
var LearningHeader = function LearningHeader(_ref2) {
  ...
  var _useState = useState(false),
    ...
    setMenuOpen = _useState2[1]; // Mobile menu toggle
  var _useState3 = useState(false),
    _useState4 = _slicedToArray(_useState3, 2),
    dropdownOpen = _useState4[0],
    setDropdownOpen = _useState4[1]; // Dropdown toggle for "للمتخصصين"
  ...
  var mainMenu = [{
    ...
    type: 'item',
    href: "".concat(config.LMS_BASE_URL, "/partners"),
    ...
    type: 'dropdown',
    // Mark it as a dropdown
    content: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("a", {
      href: "".concat(config.LMS_BASE_URL, "/courses/for_professionals")
    }, "\u0644\u0644\u0645\u062A\u062E\u0635\u0635\u064A\u0646"), /*#__PURE__*/React.createElement("span", {
    ...
    dropdown: /*#__PURE__*/React.createElement("ul", {
      className: "learning-dropdown-menu ".concat(dropdownOpen ? 'open' : '')
  ...
  return /*#__PURE__*/React.createElement("header", {
    ...
    className: "nav"
  }, mainMenu.map(function (item, index) {
    ...
    }, item.content), item.dropdown && dropdownOpen && item.dropdown);
  }))), /*#__PURE__*/React.createElement("nav", {
