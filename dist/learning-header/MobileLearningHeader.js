...
var MobileLearningHeader = /*#__PURE__*/function (_React$Component) {
  _inherits(MobileLearningHeader, _React$Component);
  var _super = _createSuper(MobileLearningHeader);
  function MobileLearningHeader(props) {
    var _this;
    _classCallCheck(this, MobileLearningHeader);
  ...
  _createClass(MobileLearningHeader, [{
    key: "toggleMenu",
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement("header", {
        ...
        href: "#main"
      }, intl.formatMessage(messages['header.label.skip.nav'])), /*#__PURE__*/React.createElement("button", {
        type: "button",
        ...
        className: "main-menu-dropdown nav flex-column position-absolute pin-left pin-right border-top shadow py-2"
      }, this.renderMainMenu()));
    }
  }]);
  return MobileLearningHeader;
}(React.Component);
...
//# sourceMappingURL=MobileLearningHeader.js.map