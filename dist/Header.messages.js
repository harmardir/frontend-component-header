...
var messages = defineMessages((_defineMessages = {
  ...
  defaultMessage: 'Courses',
  description: 'Link to the learner course dashboard'
}), _defineProperty(_defineMessages, 'header.links.partners', {
  id: 'header.links.partners',
  defaultMessage: 'Partners',
  description: 'Link to the partners page'
}), _defineProperty(_defineMessages, 'header.links.publicCourses', {
  id: 'header.links.publicCourses',
  defaultMessage: 'For Public',
  description: 'Link to the public courses page'
}), _defineProperty(_defineMessages, 'header.links.professionalCourses', {
